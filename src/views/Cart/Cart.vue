  ...
  <div class="container">
    ...
    >
      ...
      <div class="col-md-3 embed-responsive embed-responsive-16by9">
        <img
          v-bind:src="cartItem[itr - 1].imgUrl"
          class="w-100 card-img-top embed-responsive-item"
        />
      </div>
      <div class="col-md-5 px-3">
        <div class="card-block px-3">
          <h6 class="card-title" @click="showDetails(itr - 1)">
            {{ cartItem[itr - 1].pName }}
          </h6>
          ...
          <p id="item-price" class="mb-0 font-weight-bold">
            $ {{ cartItem[itr - 1].pPrice }} per unit
          </p>
          <p id="item-quantity" class="mb-0">
            ...
            <input
              ...
              v-model="cartItem[itr - 1].pQuantity"
              @change="
                updateItem(cartItem[itr - 1].id, cartItem[itr - 1].pQuantity)
              "
            />
          </p>
          <p id="item-total-price" class="mb-0">
            ...
            <span class="font-weight-bold">{{
              cartItem[itr - 1].pPrice * cartItem[itr - 1].pQuantity
            }}</span>
          </p>
          <br /><a
            href="#"
            class="text-right"
            @click="deleteItem(cartItem[itr - 1].id)"
            >Remove From Cart</a
          >
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    showDetails(itr) {
      this.$router.push({
        name: "ShowDetails",
        params: { id: this.cartItem[itr].pId },
      });
    },
